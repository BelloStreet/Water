...
void _getorb(char *fichero,int l,int ngrid,double *xi,double *yi,double *zi,double *mo_orb){
  FILE *file;
  int i,j,k,v,count=0,ncent=0,*pos,nlines,icent,n,nbasis,off,n_orb,n_occu_orb;
  ...
  double val1,val2,val,a,**center_xyz,**mo_occu,*occu,fact,S_xyz,x,y,z,*we;
