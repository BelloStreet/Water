...
std::vector<double> Quadrature_Radau::getPoints() const { return m_points; }

std::vector<double> Quadrature_Radau::getWeights() const { return m_weights; }
