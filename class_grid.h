...
class GRID{
 ...
 public:
  ...
  void _KO(int id,int numprocs,int lmerb,int *le,int lmorb,int *lo,cmplx *cilm,double *C3j,double *C3i,cmplx *K);
  void _JO(int id,int numprocs,int lmerb,int *le,int lmorb,int *lo,cmplx *cilm,double *C3j,double *C3i,cmplx *J);
  void _JMK(int id,int numprocs,int io,orbitals *p);
  void _NE(int id,int numprocs,int lmerb,int *le,double *C3j,double *C3i,cmplx *NE);
