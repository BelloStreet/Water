...
std::complex<double> *COUL90::dvrRep() const { return m_dvrRep.get(); }

std::complex<double> *COUL90::getPsik() const { return m_Psik.get(); }

std::complex<double> *COUL90::getPsikprime() const { return m_Psikprime.get(); }
