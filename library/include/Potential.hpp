...
public:
  ...
  Square(std::vector<double> i_points, std::vector<double> m_weights,
...
public:
  ...
  Step() {}
  /// Constructor of Step
  Step(std::vector<double> i_points, std::vector<double> m_weights,
       double &V_o);
};
...
public:
  ...
  Delta(std::vector<double> i_points, std::vector<double> m_weights,
        double &a_alpha);
};
...
public:
  ...
  Morse(std::vector<double> i_points, std::vector<double> m_weights,
...
public:
  ...
  Yukawa(std::vector<double> i_points, std::vector<double> m_weights,
         double &a_alpha);
};
...
public:
  ...
  Coulomb(std::vector<double> i_points, std::vector<double> m_weights,
          int &a_Z);
};
